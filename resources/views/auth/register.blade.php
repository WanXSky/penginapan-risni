...
@section('title', 'Daftar - Penginapan Risni')
...
<section class="min-h-screen flex items-center justify-center pt-24 pb-12 px-6">
    <div class="w-full max-w-md">
        ...
        <!-- Back Button -->
        <a href="/" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-800 mb-8 transition">
